...
void bst_dispose(bst_node_t **tree) {
    if ((*tree) == NULL) {
        ...
        while ((*tree) != NULL || !stack_bst_empty(&stack)) {
            if ((*tree) == NULL) {
                bst_node_t *temp = stack_bst_top(&stack);
                stack_bst_pop(&stack);
                (*tree) = temp->right;
                free(temp);
            } else {
...
void bst_preorder(bst_node_t *tree) {
    if (tree == NULL) {
        ...
        while (!stack_bst_empty(&stack)) {
            bst_node_t *temp = stack_bst_top(&stack);
            stack_bst_pop(&stack);
            bst_leftmost_preorder(temp->right, &stack);
        }
    }
}
...
void bst_inorder(bst_node_t *tree) {
    if (tree == NULL) {
        ...
        while (!stack_bst_empty(&stack)) {
            ...
            stack_bst_pop(&stack);
            bst_print_node(temp);
            bst_leftmost_inorder(temp->right, &stack);
        }
    }
}
...
void bst_postorder(bst_node_t *tree) {
    if (tree == NULL) {
        ...
        while (!stack_bst_empty(&stack)) {
            bst_node_t *temp = stack_bst_top(&stack);
            bool temp_bool = stack_bool_top(&stack_bool);
            stack_bst_pop(&stack);
            stack_bool_pop(&stack_bool);
            if (temp_bool) {
                stack_bst_push(&stack, temp);
                stack_bool_push(&stack_bool, false);
                bst_leftmost_postorder(temp->right, &stack, &stack_bool);
            } else {
                bst_print_node(temp);
            }
        }
